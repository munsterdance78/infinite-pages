-- INFINITE PAGES PLATFORM - CLEAN DATABASE SETUP
-- Complete fresh database setup for Supabase
-- This script starts with a clean slate and creates all required tables
-- Execute this file in Supabase SQL Editor for complete platform setup

-- ==============================================================================
-- PHASE 1: CLEAN SLATE - REMOVE EXISTING SCHEMA
-- ==============================================================================
...
-- ==============================================================================
-- PHASE 2: EXTENSIONS AND CORE INFRASTRUCTURE
-- ==============================================================================
...
-- ==============================================================================
-- PHASE 3: CORE USER AND CONTENT TABLES
-- ==============================================================================
...
-- ==============================================================================
-- PHASE 4: CREDIT SYSTEM AND SUBSCRIPTION MANAGEMENT
-- ==============================================================================
...
-- ==============================================================================
-- PHASE 5: CREATOR ECONOMY TABLES
-- ==============================================================================
...
-- ==============================================================================
-- PHASE 6: USER EXPERIENCE AND ANALYTICS TABLES
-- ==============================================================================
...
-- ==============================================================================
-- PHASE 7: COVER GENERATION SYSTEM
-- ==============================================================================
...
-- ==============================================================================
-- PHASE 8: AI TRANSPARENCY AND ANALYTICS
-- ==============================================================================
...
-- ==============================================================================
-- PHASE 9: CREATOR PAYOUT SYSTEM
-- ==============================================================================

-- Creator earnings accumulation tracking
CREATE TABLE creator_earnings_accumulation (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
...
CREATE TABLE monthly_payout_batches (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
...
CREATE INDEX idx_profiles_creator_tier ON profiles(creator_tier);
CREATE INDEX idx_profiles_stripe_connect_account_id ON profiles(stripe_connect_account_id);
...
CREATE INDEX idx_creator_earnings_story_id ON creator_earnings(story_id);
...
CREATE INDEX idx_story_pricing_story_id ON story_pricing(story_id);
CREATE INDEX idx_story_pricing_creator_id ON story_pricing(creator_id);
...
CREATE INDEX idx_cover_generation_queue_user_id ON cover_generation_queue(user_id);
CREATE INDEX idx_cover_generation_queue_status ON cover_generation_queue(status);
...
CREATE INDEX idx_cache_rewards_story_id ON cache_rewards(story_id);

-- Payout system indexes
CREATE INDEX idx_creator_earnings_accumulation_creator_id ON creator_earnings_accumulation(creator_id);
CREATE INDEX idx_individual_payouts_creator_id ON individual_payouts(creator_id);
CREATE INDEX idx_individual_payouts_batch_id ON individual_payouts(batch_id);
...
CREATE TRIGGER update_story_pricing_updated_at BEFORE UPDATE ON story_pricing
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
CREATE TRIGGER update_story_covers_updated_at BEFORE UPDATE ON story_covers
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_cover_generation_queue_updated_at BEFORE UPDATE ON cover_generation_queue
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_creator_earnings_accumulation_updated_at BEFORE UPDATE ON creator_earnings_accumulation
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

-- ==============================================================================
-- PHASE 13: INITIAL DATA SEEDING
-- ==============================================================================
...
VALUES (
  ...
  'Infinite Pages database successfully initialized with clean setup',
  '{"tables_created": 25, "indexes_created": 35, "policies_created": 25, "functions_created": 2, "triggers_created": 12, "seed_data_inserted": true, "initialization_date": "2025-09-22"}'::jsonb
);