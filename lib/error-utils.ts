...
export function formatErrorForStorage(errorReport: ServerErrorReport): ServerErrorReport {
  return {
    ...errorReport,
    customData: errorReport.customData ? sanitizeErrorData(errorReport.customData) : undefined,
    stack: errorReport.stack ? errorReport.stack.substring(0, 2000) : undefined // Limit stack trace
  }
}