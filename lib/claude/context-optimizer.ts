...
export class ContextOptimizer {
   ...
   */
  extractCharacterEssentials(characters: any[], chapterPlan: any): CharacterEssential[] {
   ...
   */
  compressPreviousChapters(chapters: any[]): CompressedChapterSummary[] {
   ...
   */
  selectRelevantContext(chapterPlan: any, allContext: any): OptimizedContext {
  ...
  private getChapterRelevantCharacters(characters: any[], chapterPlan: any): any[] {
  ...
  private extractCharacterGoalFromPlan(characterName: string, chapterPlan: any): string {
  ...
  private determineCurrentEmotion(character: any, chapterPlan: any): string {
  ...
  private getMostRelevantRelationship(character: any, chapterPlan: any): string {
  ...
  private extractCharacterDevelopment(chapter: any): string {
  ...
  private extractPlotAdvancement(chapter: any): string {
  ...
  private extractConsequences(chapter: any): string {
  ...
  private extractCentralConflict(foundation: any): string {
