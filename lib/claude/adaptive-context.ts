...
export class AdaptiveContextSelector {
  ...
  getPerformanceAnalytics(): {
    ...
    // Calculate averages
    const averageQuality: Record<ContextLevel, number> = {} as any
    const averageTokens: Record<ContextLevel, number> = {} as any
    const successRate: Record<ContextLevel, number> = {} as any
