...
export interface ChoiceChaptersTable {
  ...
  generation_context: any // JSONB - tracks context used for generation
  created_at: string
  updated_at: string
}
...
export interface ChoiceAnalyticsTable {
  ...
  popular_next_choices: any // JSONB
  created_at: string
  updated_at: string
}
