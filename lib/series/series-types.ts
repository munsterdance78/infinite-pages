...
export interface SeriesTable {
  ...
  total_planned_books: number
  current_book_count: number
  world_rules: any // JSONB
  character_relationships: any // JSONB
  timeline: any // JSONB
  created_at: string
  updated_at: string
}
...
export interface CharacterArcsTable {
  ...
  character_name: string
  overall_arc: string
  current_book_development: any // JSONB
  personality_evolution: any // JSONB
  key_relationships: any // JSONB
  current_status: string
  last_appearance_book: number
  arc_completion_percentage: number
  major_turning_points: any // JSONB
  created_at: string
  updated_at: string
}
